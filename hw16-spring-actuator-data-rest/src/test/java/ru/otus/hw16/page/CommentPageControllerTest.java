...
class CommentPageControllerTest {
  ...
  @SneakyThrows
  void commentsPage() {
    mockMvc.perform(MockMvcRequestBuilders.get("/comment/list/{bookId},{title}", book.getId(), book.getTitle()))
  ...
  void commentsPageWithMissingPathVariable() {
    ...
    assertThrows(IllegalArgumentException.class, () -> {
      mockMvc.perform(MockMvcRequestBuilders.get("/comment/list/{bookId},{title}", params));
    });
  }
  ...
  void commentsPageWithoutPathVariable() {
    mockMvc.perform(MockMvcRequestBuilders.get("/comment/list/"))

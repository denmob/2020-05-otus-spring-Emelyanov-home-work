...
public class BookChangelog {
  ...
  private static final String URL_GET_AUTHOR_LAST_NAME = "http://localhost:8002/api/author/lastName";
  private static final String URL_GET_GENRE_NAME = "http://localhost:8003/api/genre/name";
